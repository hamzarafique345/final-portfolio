...
//   return (
//     <section id="contact" className="text-gray-300 body-font relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
//         <div className="container px-5 pt-24 mx-auto flex sm:flex-nowrap flex-wrap">
//           <div className="lg:w-2/3 md:w-1/2 bg-slate-800/50 backdrop-blur-lg rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative border border-slate-700/50">
//             <iframe
//               width="100%"
//               height="100%"
//               title="map"
...
//             <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300 mb-8">
//               Get in Touch
//             </h2>
//             <button
...
export default function Contact() {
  ...
  const handleSubmit = (e:any) => {
    e.preventDefault();
    // NEXT_PUBLIC_EMAILJS_USER_ID="8Rsd7k1r2dQE9WPSY"
    // NEXT_PUBLIC_EMAILJS_SERVICE_ID="service_obn5dlh"
    // NEXT_PUBLIC_EMAILJS_TEMPLATE_ID="template_46qbddm"
    
    emailjs
      .sendForm(
        'service_obn5dlh', // Your EmailJS service ID
        'template_46qbddm', // Your EmailJS template ID
        e.target, // Form reference
        '8Rsd7k1r2dQE9WPSY' // Your EmailJS user ID
      )
      .then(
        (result) => {
  ...
  return (
    <section
      id="contact"
      className="text-gray-300 body-font relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900"
    >
      <div className="container px-5 pt-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-slate-800/50 backdrop-blur-lg rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative border border-slate-700/50">
          <iframe
        ...
        <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative mb-4">
              <label
                htmlFor="name"
                className="leading-10 font-extrabold font-serif text-yellow-400 text-sm text-gray-400"
              >
                Name:
              </label>
              <input
